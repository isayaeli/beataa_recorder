...
class _PianoState extends State<Piano> {
  ...
  Future<List<Pianos>> _fetchData(http.Client client) async{
    var response = await client.get("https://beatrecoder.pythonanywhere.com/api/Piano/");
    if(response.statusCode == 200){
      List jsonResponse = json.decode(response.body);
      return jsonResponse.map((e) => Pianos.fromJson(e)).toList();
    }
  }
  @override
      ...
      body: Container(
        ...
        child:FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot){
            List<Pianos> data = snapshot.data;
            if(snapshot.hasData ){
